...
class ConfigDialog(QDialog):
    ...
    def _add_directory(self):
        ...
        if folder:
            ...
            # Add to list
            self.directories.append({"filepath": folder, "search_subfolders": True})
    ...
    def _add_table_row(self, path: str, search_subfolders: bool):
        ...
        checkbox.stateChanged.connect(
            lambda state, r=row: self._update_subfolders(r, state)
        )
    ...
    def _load_config(self):
        if os.path.exists(self.config_file):
            try:
                ...
                for dir_info in self.directories:
                    self._add_table_row(
                        dir_info["filepath"], dir_info["search_subfolders"]
                    )
