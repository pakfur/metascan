...
def client_with_db():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        db.save_prompt(file_path="/data/a/img1.png", name="hero", prompt="p1",
                       target_model="qwen", architecture="qwen", styles=[],
        ...
        db.save_prompt(file_path="/data/a/img2.png", name="cinematic", prompt="p2",
                       target_model="sd", architecture="sd", styles=[],
                       temperature=None, max_tokens=None, source_prompt=None,
                       mode="generate", negative="n2", vlm_model_id=None)
...
def test_search_returns_matching_rows(client_with_db):
    c, _ = client_with_db
    r = c.post("/api/prompt/search", json={
