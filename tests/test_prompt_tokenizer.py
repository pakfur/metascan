...
class TestPromptTokenizer(unittest.TestCase):
    ...
    def test_tokenize_tags(self):
        ...
        test_cases = [
            ...
            (
                "cat, cute and fluffy, sleeping",
                {"cat", "cute fluffy", "sleeping"}
            ),
            (
                "beautiful, nice, awesome",  # all filler words
                set()
            ),
            (
    ...
    def test_tokenize_caption(self):
        ...
        test_cases = [
            ...
            (
                "a an the is are",  # all stop words
                set()
            ),
            (
                "",  # empty
    ...
    def test_edge_cases(self):
        ...
        self.assertEqual(result, {"abc", "abcd"})  # only words > 2 chars (len > 2 means 3+)
